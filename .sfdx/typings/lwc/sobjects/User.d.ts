...
declare module "@salesforce/schema/User.AccountID__c" {
  const AccountID__c:string;
  export default AccountID__c;
}
declare module "@salesforce/schema/User.AccountId" {
  const AccountId:any;
  export default AccountId;
}
declare module "@salesforce/schema/User.AccountName2__c" {
  const AccountName2__c:string;
  export default AccountName2__c;
}
declare module "@salesforce/schema/User.AccountName__c" {
  const AccountName__c:string;
  export default AccountName__c;
}
declare module "@salesforce/schema/User.Account_Id_Formula__c" {
  const Account_Id_Formula__c:string;
  export default Account_Id_Formula__c;
}
...
declare module "@salesforce/schema/User.Branding_Template__c" {
  const Branding_Template__c:string;
  export default Branding_Template__c;
}
...
declare module "@salesforce/schema/User.Closed_Credit_Account__c" {
  const Closed_Credit_Account__c:boolean;
  export default Closed_Credit_Account__c;
}
...
declare module "@salesforce/schema/User.Consumer_User__c" {
  const Consumer_User__c:boolean;
  export default Consumer_User__c;
}
...
declare module "@salesforce/schema/User.ContactId__c" {
  const ContactId__c:string;
  export default ContactId__c;
}
...
declare module "@salesforce/schema/User.EDY_ORGCUSTOM__DB__c" {
  const EDY_ORGCUSTOM__DB__c:boolean;
  export default EDY_ORGCUSTOM__DB__c;
}
declare module "@salesforce/schema/User.EDY_ORGCUSTOM__Old_First_Name__c" {
  const EDY_ORGCUSTOM__Old_First_Name__c:string;
  export default EDY_ORGCUSTOM__Old_First_Name__c;
}
declare module "@salesforce/schema/User.EDY_ORGCUSTOM__Old_Last_Name__c" {
  const EDY_ORGCUSTOM__Old_Last_Name__c:string;
  export default EDY_ORGCUSTOM__Old_Last_Name__c;
}
...
declare module "@salesforce/schema/User.Employee_Number__c" {
  const Employee_Number__c:string;
  export default Employee_Number__c;
}
declare module "@salesforce/schema/User.Extension" {
  const Extension:string;
  export default Extension;
}
declare module "@salesforce/schema/User.External_ID__c" {
...
declare module "@salesforce/schema/User.Field_Service_User__c" {
  const Field_Service_User__c:boolean;
  export default Field_Service_User__c;
}
...
declare module "@salesforce/schema/User.Key_User__c" {
  const Key_User__c:boolean;
  export default Key_User__c;
}
...
declare module "@salesforce/schema/User.Manager_PTO__c" {
  const Manager_PTO__c:any;
  export default Manager_PTO__c;
}
declare module "@salesforce/schema/User.Manager_PTO__r" {
  const Manager_PTO__r:any;
  export default Manager_PTO__r;
}
...
declare module "@salesforce/schema/User.Omni_Supervisor__c" {
  const Omni_Supervisor__c:boolean;
  export default Omni_Supervisor__c;
}
...
declare module "@salesforce/schema/User.SBQQ__DefaultProductLookupTab__c" {
  const SBQQ__DefaultProductLookupTab__c:string;
  export default SBQQ__DefaultProductLookupTab__c;
}
declare module "@salesforce/schema/User.SBQQ__OutputFormatChangeAllowed__c" {
  const SBQQ__OutputFormatChangeAllowed__c:boolean;
  export default SBQQ__OutputFormatChangeAllowed__c;
}
declare module "@salesforce/schema/User.SBQQ__ProductSortPreference__c" {
  const SBQQ__ProductSortPreference__c:string;
  export default SBQQ__ProductSortPreference__c;
}
declare module "@salesforce/schema/User.SBQQ__ResetProductLookup__c" {
  const SBQQ__ResetProductLookup__c:boolean;
  export default SBQQ__ResetProductLookup__c;
}
declare module "@salesforce/schema/User.SBQQ__Theme__c" {
  const SBQQ__Theme__c:string;
...
declare module "@salesforce/schema/User.Show_on_Checkin_Map__c" {
...
declare module "@salesforce/schema/User.TrialforceDate__c" {
  const TrialforceDate__c:any;
  export default TrialforceDate__c;
}
...
declare module "@salesforce/schema/User.UserPreferencesDisableRewardEmail" {
  const UserPreferencesDisableRewardEmail:boolean;
  export default UserPreferencesDisableRewardEmail;
}
...
declare module "@salesforce/schema/User.Work_com_Points__c" {
  const Work_com_Points__c:number;
  export default Work_com_Points__c;
}
declare module "@salesforce/schema/User.analyticsdemo_batch_id__c" {
  const analyticsdemo_batch_id__c:string;
  export default analyticsdemo_batch_id__c;
}
declare module "@salesforce/schema/User.ccrz__CC_CurrencyCode__c" {
  const ccrz__CC_CurrencyCode__c:string;
  export default ccrz__CC_CurrencyCode__c;
}
declare module "@salesforce/schema/User.ccrz__CompanyType__c" {
  const ccrz__CompanyType__c:string;
  export default ccrz__CompanyType__c;
}
declare module "@salesforce/schema/User.ccrz__ContactTypeRole__c" {
  const ccrz__ContactTypeRole__c:string;
  export default ccrz__ContactTypeRole__c;
}
declare module "@salesforce/schema/User.ccrz__DataId__c" {
  const ccrz__DataId__c:string;
  export default ccrz__DataId__c;
}
declare module "@salesforce/schema/User.ccrz__Tax_Exempt__c" {
  const ccrz__Tax_Exempt__c:boolean;
  export default ccrz__Tax_Exempt__c;
}
declare module "@salesforce/schema/User.ccrz__User_Industry__c" {
  const ccrz__User_Industry__c:string;
  export default ccrz__User_Industry__c;
}
declare module "@salesforce/schema/User.ccrz__User_Salutation__c" {
  const ccrz__User_Salutation__c:string;
  export default ccrz__User_Salutation__c;
}
...
declare module "@salesforce/schema/User.sales_management__c" {
  const sales_management__c:any;
  export default sales_management__c;
}
declare module "@salesforce/schema/User.sales_management__r" {
  const sales_management__r:any;
  export default sales_management__r;
}
